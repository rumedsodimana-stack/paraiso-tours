...
-- Marketing: social post drafts (generated by marketing agent, edited
-- and copy-pasted by admin into each platform's app — no auto-posting
-- to Instagram/Facebook/X/LinkedIn in v1).
