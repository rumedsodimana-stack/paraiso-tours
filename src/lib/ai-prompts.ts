...
export function buildWorkspaceCopilotPrompts(input: {
  ...
  return {
    ...
    systemPrompt: [
      ...
      '  "action": {',
      '    "type": "answer_only" | "create_todo" | "update_booking_status" | "create_invoice_from_booking" | "schedule_tour_from_booking" | "mark_invoice_paid" | "mark_payment_received" | "create_activity" | "create_meal_plan" | "start_booking_agent" | "send_supplier_email",',
      '    "title"?: "todo title",',
      ...
      '    "destinationId"?: "negombo|colombo|sigiriya|kandy|ella|yala|galle|mirissa|etc",',
      '    "summary"?: "activity or email description",',
      '    "durationLabel"?: "2 hours",',
      '    "energy"?: "easy|moderate|active",',
      '    "estimatedPrice"?: number,',
      '    "hotelQuery"?: "hotel name or id",',
      '    "label"?: "meal plan label like BB or HB",',
      '    "pricePerPerson"?: number,',
      '    "currency"?: "USD",',
      '    "supplierQuery"?: "supplier name or id",',
