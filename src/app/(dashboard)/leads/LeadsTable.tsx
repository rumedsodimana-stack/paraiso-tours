              ...
              {filteredLeads.length === 0 ? (
                <tr>
                  <td colSpan={6} className="px-6 py-12 text-center text-stone-500">
                    No leads found.{" "}
                    <Link href="/leads/new" className="text-teal-600 hover:text-teal-700 font-medium">
                      Add your first lead
                    </Link>
                  </td>
                </tr>
                      ...
                      <div className="relative inline-block">
                        ...
                        {openMenu === lead.id && (
                          <>
                            ...
                            />
                            <div className="absolute right-0 top-full z-20 mt-1 w-40 rounded-xl border border-white/30 bg-white/95 py-1 shadow-xl backdrop-blur-xl">
                              {lead.source === "Client Portal" && lead.packageId && (
                                <Link
                                  href={`/tours/new?leadId=${encodeURIComponent(lead.id)}`}
