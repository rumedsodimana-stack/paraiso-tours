...
export default async function UserGuidePage() {
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-12">
      <div className="paraiso-card rounded-2xl p-8">
        <div className="flex items-start gap-4">
          <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-[#eef4f4]">
            <BookOpen className="h-7 w-7 text-[#12343b]" />
          </div>
          <div>
            <h1 className="text-2xl font-bold text-[#11272b]">
              {brandName} — User Guide
            </h1>
            <p className="mt-2 text-[#5e7279]">
      ...
      {/* Table of Contents */}
      <nav className="rounded-xl border border-[#e0e4dd] bg-[#fffbf4] p-6">
        <h2 className="text-lg font-semibold text-[#11272b]">Table of contents</h2>
      ...
      <div className="rounded-xl border border-teal-200 bg-teal-50/40 p-4">
        <h3 className="font-semibold text-[#11272b]">Recent updates</h3>
        <ul className="mt-2 space-y-1 text-sm text-[#5e7279]">
      ...
      <section id="overview" className="scroll-mt-6">
        <h2 className="flex items-center gap-2 text-xl font-bold text-[#11272b]">
        ...
        <div className="mt-4 flex gap-4">
          <Link href="/" className="inline-flex items-center gap-2 rounded-xl bg-[#12343b] px-4 py-2 text-sm font-medium text-[#f6ead6] hover:bg-[#1a474f]" target="_blank">
            Open Client Portal
            <ChevronRight className="h-4 w-4" />
          </Link>
          <Link href="/admin" className="inline-flex items-center gap-2 rounded-xl border border-[#e0e4dd] px-4 py-2 text-sm font-medium text-[#11272b] hover:bg-[#f4ecdd]">
            Admin Dashboard
            <ChevronRight className="h-4 w-4" />
          </Link>
        </div>
      ...
      <section id="client-portal" className="scroll-mt-6">
        ...
        <div className="mt-6 space-y-6">
          <div className="rounded-xl border border-[#e0e4dd] bg-[#fffbf4] p-6">
            <h3 className="flex items-center gap-2 font-semibold text-[#11272b]">
              <Home className="h-5 w-5 text-[#12343b]" />
              Home (/)
            </h3>
            <ul className="mt-3 list-inside list-disc space-y-1 text-sm text-[#5e7279]">
          ...
          <div className="rounded-xl border border-[#e0e4dd] bg-[#fffbf4] p-6">
            <h3 className="flex items-center gap-2 font-semibold text-[#11272b]">
              <Package className="h-5 w-5 text-[#12343b]" />
              Packages (/packages)
            </h3>
            <ul className="mt-3 list-inside list-disc space-y-1 text-sm text-[#5e7279]">
      ...
      <section id="admin-portal" className="scroll-mt-6">
        ...
        <div className="mt-6 space-y-6">
          ...
          <div className="rounded-xl border border-[#e0e4dd] bg-[#fffbf4] p-6">
            <h3 className="flex items-center gap-2 font-semibold text-[#11272b]">
              <Banknote className="h-5 w-5 text-[#12343b]" />
          ...
          <div className="rounded-xl border border-[#e0e4dd] bg-[#fffbf4] p-6">
            <h3 className="flex items-center gap-2 font-semibold text-[#11272b]">
              <Settings className="h-5 w-5 text-[#12343b]" />
      ...
      <section id="auth-password" className="scroll-mt-6">
        ...
        <p className="mt-4 text-[#5e7279]">
          <strong>Default password:</strong> <code className="rounded bg-stone-100 px-1">admin123</code>. Change it in <Link href="/admin/settings" className="text-[#12343b] hover:underline">Settings</Link> → Change Admin Password.
        </p>
        <ul className="mt-4 list-inside list-disc space-y-1 text-sm text-[#5e7279]">
      ...
      <section id="ai-setup" className="scroll-mt-6">
        ...
        <div className="mt-6 rounded-xl border border-[#e0e4dd] bg-[#fffbf4] p-6">
          <h3 className="flex items-center gap-2 font-semibold text-[#11272b]">
            <Bot className="h-5 w-5 text-[#12343b]" />
            Gemini runtime
          </h3>
          <ul className="mt-3 list-inside list-disc space-y-1 text-sm text-[#5e7279]">
            <li>Open <Link href="/admin/settings?section=ai" className="text-[#12343b] hover:underline">Settings → AI Control Center</Link>.</li>
            ...
            <li>Use the header AI button for quick chat, or <Link href="/admin/ai" className="text-[#12343b] hover:underline">AI Workspace</Link> for the full screen.</li>
          </ul>
        </div>
      </section>
      ...
      <section id="whatsapp" className="scroll-mt-6">
        ...
        <div className="mt-6 space-y-4">
          <div>
            ...
            <p className="mt-1 text-sm text-[#5e7279]">
              Go to <Link href="/admin/settings" className="text-[#12343b] hover:underline">Settings</Link> and use the
          ...
          <p className="text-sm text-stone-500">
            Full setup guide:{" "}
            <a href="https://developers.facebook.com/docs/whatsapp/cloud-api/get-started" target="_blank" rel="noopener noreferrer" className="text-[#12343b] hover:underline">
        ...
        <div className="mt-6 space-y-4">
          <div className="flex items-start gap-3 rounded-xl border border-emerald-200 bg-emerald-50/50 p-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-[#5e7279]">Bookings (leads) persist in Supabase. Ensure supabase/schema.sql has been run in your Supabase project.</p>
            </div>
          </div>
          <div className="flex items-start gap-3 rounded-xl border border-emerald-200 bg-emerald-50/50 p-4">
            <CheckCircle2 className="h-5 w-5 shrink-0 text-emerald-600" />
            <div>
              ...
              <p className="mt-1 text-sm text-[#5e7279]">Guests receive booking confirmation, tour confirmation with invoice, and payment receipts. Suppliers receive reservation emails when you schedule a tour.</p>
            </div>
          </div>
          <div className="flex items-start gap-3 rounded-xl border border-emerald-200 bg-emerald-50/50 p-4">
            <CheckCircle2 className="h-5 w-5 shrink-0 text-emerald-600" />
            <div>
              ...
              <p className="mt-1 text-sm text-[#5e7279]">Password protected via ADMIN_PASSWORD. Log in at /admin/login.</p>
            </div>
          </div>
          <div className="flex items-start gap-3 rounded-xl border border-emerald-200 bg-emerald-50/50 p-4">
            <CheckCircle2 className="h-5 w-5 shrink-0 text-emerald-600" />
            <div>
              ...
              <p className="mt-1 text-sm text-[#5e7279]">Client browse, book, look up. Admin manages bookings, packages, suppliers, tours, calendar. Invoices &amp; payments persisted and synced.</p>
            </div>
          </div>
        </div>

        <p className="mt-6 text-sm text-stone-500">
          See <Link href="https://github.com/rumedsodimana-stack/paraiso-tours/blob/main/IMPROVEMENTS.md" className="text-[#12343b] hover:underline">IMPROVEMENTS.md</Link> for the full roadmap.
        </p>
      </section>
    </div>
  );
