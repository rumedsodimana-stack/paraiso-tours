    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-[#5e7279]">
          Outstanding supplier payments due. Mark as paid when transferred.
        </p>
      </div>
      ...
      <div className="space-y-3">
        ...
        {pending.length === 0 ? (
          <div className="rounded-2xl border border-dashed border-[#ddd3c4] bg-[#faf6ef] p-8 text-center">
            ...
            <p className="text-sm font-medium text-[#375a3f]">All settled</p>
            <p className="mt-1 text-xs text-[#8a9ba1]">No outstanding supplier payments</p>
          </div>
        ) : (
          pending.map((p) => (
            <div
            ...
            >
              <div className="flex items-center gap-4 min-w-0">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#eed9cf]">
                  <AlertCircle className="h-5 w-5 text-[#7c3a24]" />
                </div>
                <div className="min-w-0">
                  <p className="font-semibold text-[#11272b] truncate">
                    {p.supplierName ?? p.description}
                  </p>
              ...
              <div className="flex shrink-0 items-center gap-4">
                <div className="text-right">
                  <p className="font-bold text-[#7c3a24]">
                    {p.amount.toLocaleString()} {p.currency}
                  </p>
                  <span className="rounded-full bg-[#eed9cf] px-2 py-0.5 text-[10px] font-semibold text-[#7c3a24]">
                    Pending
                  </span>
                </div>
